 ...
 * (GenCodeChecksum:7c3040b7535ffbe0570ed979b4158850)
 */
...
class CRM_Eventbrite_DAO_EventbriteLog extends CRM_Core_DAO {
  ...
  /**
   * Message type. See CRM_Eventbrite_BAO_EventbriteLog::MESSAGE_TYPE_*
   *
   * @var int unsigned
   */
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'message_type_id' => [
          ...
          'type' => CRM_Utils_Type::T_INT,
          'description' => ts('Message type. See CRM_Eventbrite_BAO_EventbriteLog::MESSAGE_TYPE_*'),
          'table_name' => 'civicrm_eventbrite_log',
          'entity' => 'EventbriteLog',
          'bao' => 'CRM_Eventbrite_DAO_EventbriteLog',
          'localizable' => 0,
